//ลิส Topic
let topics_requestment = ['โจทย์การบ้านที่อาจารย์สั่งไว้ให้รายละเอียดข้อกำหนดไม่ครบหรือเปล่าคะ หาคำตอบไม่ได้ค่ะ', 'อาจารย์ลงเฉลยข้อสอบให้หน่อยครับ', 'ขอเฉลยการบ้านข้อนี้ครับ'];
//ระบุที่ที่จะเอาไปใส่
let boxofrequestment = document.getElementById('requestment_card');
//ลิสที่จะดึงมาที่ละตัว.forEach(ดึงมาไว้ในตัวแปรช่องนี้)
topics_requestment.forEach((topic) => {
    ...
    divHTML += '</div>';
    // รวม
    boxofrequestment.innerHTML += divHTML;
})