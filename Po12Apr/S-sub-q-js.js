...
let assessment2 = document.getElementById('assessment_card');
...
topics_assessment.forEach((topic) =>{
    ...
    formhtml.append(labelcustom,labelcustom2,labelcustom3);
    divbox.append(formhtml);
